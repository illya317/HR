...
const ENDPOINTS = [
  ...
  { method: "PUT", path: "/api/hr/employees/:id", note: "更新员工单字段", params: "{field, value}", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/employees/:id", note: "删除员工", perm: "people.access" },
  { method: "GET", path: "/api/hr/employments", note: "雇佣关系列表", perm: "people.access" },
  { method: "POST", path: "/api/hr/employments", note: "新建雇佣关系", perm: "people.access" },
  { method: "PUT", path: "/api/hr/employments/:id", note: "更新雇佣关系", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/employments/:id", note: "删除雇佣关系", perm: "people.access" },
  { method: "GET", path: "/api/hr/departments", note: "部门列表", params: "?keyword", perm: "people.access" },
  { method: "POST", path: "/api/hr/departments", note: "新建部门", perm: "people.access" },
  { method: "PUT", path: "/api/hr/departments/:id", note: "更新部门", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/departments/:id", note: "删除部门", perm: "people.access" },
  { method: "GET", path: "/api/hr/positions", note: "岗位列表", params: "?keyword", perm: "people.access" },
  { method: "POST", path: "/api/hr/positions", note: "新建岗位", perm: "people.access" },
  { method: "PUT", path: "/api/hr/positions/:id", note: "更新岗位", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/positions/:id", note: "删除岗位", perm: "people.access" },
  { method: "GET", path: "/api/hr/edps", note: "EDP 列表", perm: "people.access" },
  { method: "POST", path: "/api/hr/edps", note: "新建 EDP", perm: "people.access" },
  { method: "PUT", path: "/api/hr/edps/:id", note: "更新 EDP", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/edps/:id", note: "删除 EDP", perm: "people.access" },
  { method: "GET", path: "/api/hr/companies", note: "公司列表", perm: "people.access" },
  { method: "POST", path: "/api/hr/companies", note: "新建公司", perm: "people.access" },
  { method: "PUT", path: "/api/hr/companies/:id", note: "更新公司", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/companies/:id", note: "删除公司", perm: "people.access" },
  { method: "GET", path: "/api/hr/projects", note: "项目列表", perm: "people.access" },
  { method: "POST", path: "/api/hr/projects", note: "新建项目", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/projects/:id", note: "删除项目", perm: "people.access" },
  { method: "GET", path: "/api/hr/employee-projects", note: "项目员工列表", perm: "people.access" },
  { method: "POST", path: "/api/hr/employee-projects", note: "新建项目员工", perm: "people.access" },
  { method: "DELETE", path: "/api/hr/employee-projects/:id", note: "删除项目员工", perm: "people.access" },
